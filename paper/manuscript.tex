...
\textbf{Retrocue benefit.} At both set sizes, cued items were recalled with significantly lower error than uncued (neutral) items: at $N\!=\!2$, cued MAE $= 9.5^\circ$ vs.\ neutral MAE $= 15.8^\circ$ ($t = 4.30$, $p < 10^{-4}$); at $N\!=\!4$, cued MAE $= 23.5^\circ$ vs.\ neutral MAE $= 35.3^\circ$ ($t = 4.60$, $p < 10^{-5}$), confirming a robust retrocue benefit at both load levels (Fig.~\ref{fig:retrocue}B).

\textbf{Set-size interaction.} The retrocue benefit was significantly larger at $N\!=\!4$ ($11.8^\circ \pm 2.6^\circ$) than at $N\!=\!2$ ($6.4^\circ \pm 1.5^\circ$; $t = 1.83$, $p = 0.034$, one-tailed), replicating the well-established empirical finding \cite{souzaRetrocuesRetroactiveAttentional2016, gunseliSerialOffloadingWorking2015} that selective cueing confers a greater advantage under higher memory load (Fig.~\ref{fig:retrocue}C).
...
\begin{table}[H]
\centering
\caption{\textbf{Configuration parameters across experiments.}}
\label{tab:params}
\small
\begin{tabular}{lccc}
\toprule
...
\begin{table}[H]
\centering
\caption{\textbf{Information-theoretic model comparison.}
AIC, BIC, and AICc for four benchmark models fit by MLE to $n = 1{,}300$ pooled MemGP simulation errors (100 trials $\times$ set sizes 1, 2, 4, 6). $\Delta$AIC and $\Delta$BIC are differences from the best-fitting model (VP). By conventional guidelines ($\Delta > 10$ indicates essentially no support; Burnham \& Anderson, 2002), VP is decisively preferred.}
\label{tab:ic}
\small
\begin{tabular}{lccrrrrr}
\toprule
\textbf{Model} & $k$ & $-\ln\hat{L}$ & \textbf{AIC} & \textbf{BIC} & \textbf{AICc} & $\Delta$\textbf{AIC} & $\Delta$\textbf{BIC} \\
\midrule
VP & 4 & 724.4 & 1456.9 & 1477.6 & 1456.9 & 0.0 & 0.0 \\
IL & 3 & 745.6 & 1497.1 & 1512.6 & 1497.1 & 40.2 & 35.1 \\
SA & 3 & 780.3 & 1566.7 & 1582.2 & 1566.7 & 109.8 & 104.6 \\
EP & 3 & 967.6 & 1941.2 & 1956.7 & 1941.2 & 484.3 & 479.2 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \caption{\textbf{Comparison with human data.}
